...
const cashflowIntelRouter = require('./routes/cashflow-intel');
const bankRouter = require('./routes/bank');
const operationalEventsRouter = require('./routes/operational-events');
const operationalActionsRouter = require('./routes/operational-actions');
...
const betterHomeHandoffsRouter = require('./routes/better-home-handoffs');
const b2bProspectsRouter = require('./routes/b2b-prospects');
const builderIntelRouter = require('./routes/builder-intel');
...
app.use('/api/cashflow-intel', cashflowIntelRouter);
app.use('/api/bank', bankRouter);
app.use('/api/operational-events', operationalEventsRouter);
app.use('/api/operational-actions', operationalActionsRouter);
...
app.use('/api/internal/better-home-handoffs', betterHomeHandoffsRouter);
app.use('/api/b2b-prospects', b2bProspectsRouter);
app.use('/api/builder-intel', builderIntelRouter);
