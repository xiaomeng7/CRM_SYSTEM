 ...
 *
 * Copied from apps/web/pre-purchase-landing/netlify/functions/ so that the new
 * Astro marketing site can reuse the same booking endpoint without depending
 * on the legacy pre-purchase-landing site being deployed.
 */
