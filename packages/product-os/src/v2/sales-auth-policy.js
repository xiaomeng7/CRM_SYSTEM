...
const PERMISSIONS=Object.freeze({
  SALES:new Set(["CATALOG_READ","DRAFT_CREATE","DRAFT_READ_OWN","DRAFT_WRITE_OWN","PROPOSAL_PREVIEW"]),
  MANAGER:new Set(["CATALOG_READ","DRAFT_CREATE","DRAFT_READ_OWN","DRAFT_WRITE_OWN","DRAFT_READ_ALL","DRAFT_WRITE_ALL","PROPOSAL_PREVIEW","PROPOSAL_REVIEW","PROPOSAL_APPROVE","PROPOSAL_ACCEPT_RECORD","OPERATIONAL_HANDOFF_PREVIEW"]),
  ADMIN:new Set(["CATALOG_READ","DRAFT_CREATE","DRAFT_READ_OWN","DRAFT_WRITE_OWN","DRAFT_READ_ALL","DRAFT_WRITE_ALL","PROPOSAL_PREVIEW","PROPOSAL_REVIEW","PROPOSAL_APPROVE","PROPOSAL_SEND","PROPOSAL_ACCEPT_RECORD","OPERATIONAL_HANDOFF_PREVIEW","OPERATIONAL_HANDOFF_AUTHORIZE","USER_ADMIN","PRODUCT_OS_ADMIN"])
});
